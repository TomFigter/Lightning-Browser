package com.privates.browser.adblock

import com.privates.browser.R
import com.privates.browser.adblock.source.HostsDataSourceProvider
import com.privates.browser.adblock.source.HostsResult
import com.privates.browser.adblock.util.BloomFilter
import com.privates.browser.adblock.util.DefaultBloomFilter
import com.privates.browser.adblock.util.DelegatingBloomFilter
import com.privates.browser.adblock.util.`object`.JvmObjectStore
import com.privates.browser.adblock.util.`object`.ObjectStore
import com.privates.browser.adblock.util.hash.MurmurHashHostAdapter
import com.privates.browser.adblock.util.hash.MurmurHashStringAdapter
import com.privates.browser.database.adblock.Host
import com.privates.browser.database.adblock.HostsRepository
import com.privates.browser.database.adblock.HostsRepositoryInfo
import com.privates.browser.di.DatabaseScheduler
import com.privates.browser.di.MainScheduler
import com.privates.browser.extensions.toast
